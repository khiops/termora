...
fn test_output_data_is_msgpack_bin() {
	...
	let output = rmpv::Value::Map(vec![
		(rmpv::Value::String("type".into()), rmpv::Value::String("OUTPUT".into())),
		(rmpv::Value::String("channel_id".into()), rmpv::Value::String("ch-1".into())),
		(rmpv::Value::String("seq".into()), rmpv::Value::Integer(1.into())),
		(rmpv::Value::String("ts".into()), rmpv::Value::String("2026-01-01T00:00:00.000Z".into())),
		// Binary payload: ESC [ H (cursor-home sequence)
		(rmpv::Value::String("data".into()), rmpv::Value::Binary(vec![0x1b, 0x5b, 0x48])),
	]);
...
fn test_field_names_snake_case() {
	let spawn_ok = rmpv::Value::Map(vec![
		(rmpv::Value::String("type".into()), rmpv::Value::String("SPAWN_OK".into())),
		(rmpv::Value::String("request_id".into()), rmpv::Value::String("req-1".into())),
		(rmpv::Value::String("channel_id".into()), rmpv::Value::String("ch-1".into())),
	]);
...
fn test_serialization_is_map_not_array() {
	let hello = rmpv::Value::Map(vec![
		(rmpv::Value::String("type".into()), rmpv::Value::String("HELLO".into())),
		(rmpv::Value::String("version".into()), rmpv::Value::Integer(1.into())),
	]);
...
fn test_frame_length_prefix_is_little_endian() {
	let msg = rmpv::Value::Map(vec![
		(rmpv::Value::String("type".into()), rmpv::Value::String("HEARTBEAT_ACK".into())),
		(rmpv::Value::String("ts".into()), rmpv::Value::String("2026-01-01T00:00:00Z".into())),
	]);
...
fn test_channel_exit_code_is_integer() {
	let exit_msg = rmpv::Value::Map(vec![
		(rmpv::Value::String("type".into()), rmpv::Value::String("CHANNEL_EXIT".into())),
		(rmpv::Value::String("channel_id".into()), rmpv::Value::String("ch-1".into())),
		(rmpv::Value::String("exit_code".into()), rmpv::Value::Integer(0.into())),
	]);
