...
- [ ] 🔧 [Hub] DRY: extract shared SendQueue from LocalAgent + SshAgent backpressure — Priority: M (F-001)
- [ ] 🔧 [Hub] Add auth enforcement tests for API routes (PATCH /api/channels/:id etc.) — Priority: M (F-009)
- [ ] 🔧 [Hub] Add backpressure queue unit tests (drop at 1000, drain, double-drain) — Priority: M (F-010)
